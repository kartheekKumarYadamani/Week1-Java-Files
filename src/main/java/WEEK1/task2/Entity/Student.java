...
public class Student {
    ...
    public Student(Integer studentId, String studentName, String qualification, List<String> skills,
                   Integer experience, String preferredTechnology, Double budget) {
        this.studentId = studentId;
        this.studentName = studentName;
        this.qualification = qualification;
        this.skills = skills;
